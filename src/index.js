...
class WebCLI extends HTMLElement {
    ...
    writeMeteoForecast(forecasts) {
        ...
        for (let i = 0; i < forecasts.length; i++) {
            ...
            markup += `<p>${forecast.dt_txt.split(':')[0]}: ${forecast.weather[0].description} - ${forecast.main[0].temp} - <img class="icon" src="http://openweathermap.org/img/w/${forecast.weather[0].icon}.png" alt="Weather icon"><p/>`;
        }
